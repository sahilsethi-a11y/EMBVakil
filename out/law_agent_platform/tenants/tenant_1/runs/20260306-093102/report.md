...
This NDA restricts use and disclosure of confidential information exchanged between Eagles Communication Consultancy and another party, for business evaluation or job execution purposes. Several risk issues are present, especially in the indemnity and liability clauses, which are one-sided and uncapped, exposing the counterparty to substantial risk. The review also flags assignment and accrued rights clauses as not sufficiently mutual or aligned with playbook standards. Improvements are recommended for mutuality and limitation of liability throughout.
...
- Counterparty name and execution date are placeholders and not filled in.
- ECC is a registered company in Abu Dhabi.
- MAHMOUD SAYED AHMAD signs for ECC; the other party is generically referred to.
