...
This is a standard one-way non-disclosure agreement (NDA) to protect confidential business information disclosed between two parties.
...
- Parties and date fields are blank and not specified in the supplied text.
- Document extracted from a standard template, so parties must be filled in to finalize agreement.
