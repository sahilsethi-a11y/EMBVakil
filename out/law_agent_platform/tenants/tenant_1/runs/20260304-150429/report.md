...
A mutual non-disclosure agreement (NDA) between Eagles Communication Consultancy (ECC) and a counterparty (company or individual/person) covering the sharing of confidential information for evaluating potential business opportunities.
...
- Counterparty name is a placeholder and not specified in the provided text.
- Effective date is left as a variable and not filled in the provided text.
- Signatory for ECC is Mahmoud Sayed Ahmad, Executive Manager.
- Contract type is NDA as stated in the heading.
