...
This contract is a mutual non-disclosure agreement (NDA) between Eagles Communication Consultancy (ECC) and another company or individual for the exchange of confidential information, intended to support the evaluation or establishment of a business relationship. Significant high-risk issues were found regarding one-sided and uncapped indemnity and liability provisions, as well as lack of mutuality in key areas (indemnity, rights on termination). Several medium-risk issues relate to assignment restrictions and preservation of rights upon termination. The contract will require revision for mutuality, capping of liabilities, and assignment language to achieve alignment with standard risk controls.
...
- Counterparty's actual name and effective date placeholder not filled in the provided text.
- MAHMOUD SAYED AHMAD signs on behalf of ECC as Executive Manager.
- Governing law is stated as United Arab Emirates.
- Term is five years from signature; confidentiality obligations last three years post-termination.
- References to attachments (passport/ID/trade license) for INDIVIDUAL or COMPANY are not completed.
