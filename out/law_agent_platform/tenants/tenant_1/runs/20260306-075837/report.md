...
A mutual Non-Disclosure Agreement between Eagles Communication Consultancy (ECC) and another company or individual for exchanging confidential information to evaluate potential business opportunities or job execution.
...
- Counterparty name is left blank and referred to throughout as COMPANY or INDIVIDUAL / PERSON.
- Effective Date is blank and should be completed before execution.
- No specific dates for execution, only terms for duration and survival of obligations.
- ECC is based in Abu Dhabi, UAE; the NDA is governed by UAE law.
