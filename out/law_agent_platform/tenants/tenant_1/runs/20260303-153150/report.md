...
A mutual NDA template that obligates the receiving party to keep confidential information secret, defines exclusions, describes duration and outlines return of information and other standard NDA clauses.
...
- Party names and exact dates are blank and need to be filled in during execution.
- Both parties will execute (sign) the agreement via authorized representatives.
